...
for(ex in c("B1", "B2A", "B2B", "B2C", "E1", "E2A", "E2B", "E2C", "E1B1")){
...
### Then, for data analysis, create tables for all reps from: 1- all B exps, 2- all E exps, 3- E1B1 ex
...
meansInd.B1$ex = rep("B1", length(meansInd.B1$Rep))
meansInd.B2A$ex = rep("B2A", length(meansInd.B2A$Rep))
meansInd.B2B$ex = rep("B2B", length(meansInd.B2B$Rep))
meansInd.B2C$ex = rep("B2C", length(meansInd.B2C$Rep))
...
meansInd.E1$ex = rep("E1", length(meansInd.E1$Rep))
meansInd.E2A$ex = rep("E2A", length(meansInd.E2A$Rep))
meansInd.E2B$ex = rep("E2B", length(meansInd.E2B$Rep))
meansInd.E2C$ex = rep("E2C", length(meansInd.E2C$Rep))
...
meansInd.E1B1$ex = rep("E1B1", length(meansInd.E1B1$Rep))
