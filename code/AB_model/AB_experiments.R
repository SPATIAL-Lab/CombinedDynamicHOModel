...
for(ex in c("B1", "B2A", "B2B", "B2C", "E1", "E2A", "E2B", "E2C", "E1B1")){
  ...
  BirdParms = data.frame("Rep"=c(1:Reps), "ThirstIncreaseNight"=ThirstIncreaseNight, 
                         "ThirstIncreaseDay"=ThirstIncreaseDay, 
                         "HungerIncreaseNight"=HungerIncreaseNight, 
                         "HungerIncreaseDay"=HungerIncreaseDay, 
                         "AvEatSuccRate"=AvEatSuccRate, "WeightType1"=WeightType1, 
                         "WeightType2"=WeightType2, "WeightType4"=WeightType4, 
                         "Search.dist"=Search.dist, "HomeLocHab"=HomeLocHab)
